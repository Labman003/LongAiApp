package com.ouzhouren.longai.view.welcome.activity.fragment.outlayer;
...
import com.ouzhouren.longai.model.TextBean;
import com.ouzhouren.longai.view.welcome.activity.fragment.base.LoginAnimImageBaseFragment;
import com.ouzhouren.longai.view.welcome.activity.fragment.outlayer.welcomelayer.LoginAnimImageFristFragment;
import com.ouzhouren.longai.view.welcome.activity.fragment.outlayer.welcomelayer.LoginAnimImageSecondFragment;
import com.ouzhouren.longai.view.welcome.activity.fragment.outlayer.welcomelayer.LoginAnimImageThridFragment;
import com.ouzhouren.longai.view.welcome.adapter.ImageFragmentStatePagerAdapter;
import com.ouzhouren.longai.view.welcome.adapter.TextFragmentStatePagerAdapter;
import com.ouzhouren.longai.view.welcome.view.ChildViewPager;
import com.ouzhouren.longai.view.welcome.view.WelcomeIndicator;
...
public class WelcomAnimFragment extends Fragment {
    ...
    private void initTextFragmentViewPager(){
        ...
        bean0.mId = 0;
        bean0.mTitle = "欢迎来到龙爱!";
        bean0.mContent = "在开始您的寻爱旅途之前.一起来了解一下龙爱的几个特色吧";
        mTextBeans.add(bean0);

        TextBean bean1 = new TextBean();
        bean1.mId = 1;
        bean1.mTitle = "缘分匹配";
        bean1.mContent = "基于独创缘分算法，推荐你喜欢的人，把你推荐给喜欢你的人。";
        mTextBeans.add(bean1);

        TextBean bean2 = new TextBean();
        bean2.mId = 2;
        bean2.mTitle = "恋爱私房菜";
        bean2.mContent = "在这里，小编想教你那些很重要又被忽略的、关于成长和恋爱的技巧。";
        mTextBeans.add(bean2);

        TextBean bean3 = new TextBean();
        bean3.mId = 3;
        bean3.mTitle = "龙爱一线牵!";
        bean3.mContent = "龙爱官方线下活动，面对面，更容易搭讪！~.";
